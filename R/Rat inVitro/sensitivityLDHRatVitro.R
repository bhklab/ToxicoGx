#' TG-GATES Rat in vitro
#' 
#' Program generates objects of sensitivity info, sensitivity raw, and sensitivity profiles
#' Input includes phenoData object created from phenoRatVitro.R
